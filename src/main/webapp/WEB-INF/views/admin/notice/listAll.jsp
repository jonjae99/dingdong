		...
		<div class="card mb-4">
			...
			<div class="card-body">
				...
				<table id="datatablesSimple">
					...
					<tbody>
						<c:forEach var="communityBoard" items="${noticeList}">
							<tr>
								<td>${communityBoard.category }</td>
								<td>${communityBoard.boardNum }</td>
								<td><a class="a" href="${contextPath }/admin/notice/detail?boardNum=${communityBoard.boardNum}">${communityBoard.title }</a></td>
